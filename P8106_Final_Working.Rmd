...
Based on the confusion matrix from test data predictions, the accuracy of the linear SVM model is **0.745**, or 74.5%. The misclassification rate is 1 − Accuracy = **0.255**, meaning 25.5% of test observations were incorrectly classified.
